...
typedef enum {
  ...
  err_ENCLAVE__LOADPB__NO_RATELIMIT_SECRET,
  ...
  err_ENCLAVE__RETRYRESPONSE__DEPRECATED__ = 1000,  // enclave_retry_response, removed
  ...
  err_SHARD__ALREADY_RUNNING,
  err_SHARD__NOT_RUNNING,
